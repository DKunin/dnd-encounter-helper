const spellsObject = {
    'Acid Splash': {
        classes: ['Rogue', 'Fighter', 'Sorcerer', 'Wizard'],
        components: ['S', 'V'],
    ...
    'Bestow Curse': {
        classes: ['Paladin', 'Cleric', 'Wizard', 'Bard'],
        components: ['S', 'V'],
        duration: 'Concentration, up to 1 minute',
        level: 3,
        material: null,
    ...
    'Blade Ward': {
        classes: ['Sorcerer', 'Bard', 'Fighter', 'Warlock', 'Rogue', 'Wizard'],
        components: ['S', 'V'],
        duration: '1 round',
        level: 0,
        material: null,
    ...
    'Blindness/Deafness': {
        classes: ['Sorcerer', 'Cleric', 'Warlock', 'Wizard', 'Bard'],
        components: ['V'],
        duration: '1 minute',
        level: 2,
        material: null,
    ...
    Blur: {
        classes: ['Druid', 'Sorcerer', 'Rogue', 'Wizard'],
        components: ['V'],
        duration: 'Concentration, up to 1 minute',
        level: 2,
        material: null,
    ...
    'Burning Hands': {
        classes: ['Fighter', 'Sorcerer', 'Cleric', 'Warlock', 'Wizard'],
        components: ['S', 'V'],
        duration: 'Instantaneous',
        level: 1,
        material: null,
    ...
    Cloudkill: {
        classes: ['Druid', 'Sorcerer', 'Cleric', 'Wizard'],
        components: ['S', 'V'],
        duration: 'Concentration, up to 10 minutes',
        level: 5,
        material: null,
    ...
    'Conjure Minor Elementals': {
        ...
        source_page: 226,
        text:
            "You summon elementals that appear in unoccupied spaces that you can see within range. You choose one the following options for what appears. \u00e2\u20ac\u00a2 One elemental of challenge rating 2 or lower \u00e2\u20ac\u00a2 Two elementals of challenge rating 1 or lower \u00e2\u20ac\u00a2 Four elementals of challenge rating 1/2 or lower \u00e2\u20ac\u00a2 Eight elementals of challenge rating 1/4 or lower. An elemental summoned by this spell disappears when it drops to 0 hit points or when the spell ends. The summoned creatures are friendly to you and your companions. Roll initiative for the summoned creatures as a group, which has its own turns. They obey any verbal commands that you issue to them (no action required by you). If you don't issue any commands to them, they defend themselves from hostile creatures, but otherwise take no actions. The DM has the creatures' statistics. At Higher Levels: When you cast this spell using certain higher-level spell slots, you choose one of the summoning options above, and more creatures appear - twice as many with a 6th-level slot and three times as many with an 8th-level slot",
        time: '1 minute'
    },
    'Conjure Volley': {
        classes: ['Ranger'],
    ...
    'Conjure Woodland Beings': {
        ...
        source_page: 226,
        text:
            "You summon fey creatures that appear in unoccupied spaces that you can see within range. Choose one of the following options for what appears. \u00e2\u20ac\u00a2 One fey creature of challenge rating 2 or lower \u00e2\u20ac\u00a2 Two fey creatures of challenge rating 1 or lower \u00e2\u20ac\u00a2 Four fey creatures of challenge rating 1/2 or lower \u00e2\u20ac\u00a2 Eight fey creatures of challenge rating 1/4 or lower A summoned creature disappears when it drops to 0 hit points or when the spell ends. The summoned creatures are friendly to you and your companions. Roll initiative for the summoned creatures as a group, which have their own turns. They obey any verbal commands that you issue to them (no action required by you). If you don't issue any commands to them, they defend themselves from hostile creatures, but otherwise take no actions. The DM has the creatures' statistics. At Higher Levels: When you cast this spell using certain higher-level spell slots, you choose one of the summoning options above, and more creatures appear - twice as many with a 6th-level slot and three times as many with an 8th-level slot.",
        time: '1 action'
    },
    'Contact Other Plane': {
    ...
    Contagion: {
        classes: ['Druid', 'Paladin', 'Warlock', 'Cleric'],
        components: ['S', 'V'],
        duration: '7 days',
        level: 5,
        material: null,
    ...
    'Crown of Madness': {
        classes: ['Paladin', 'Sorcerer', 'Bard', 'Warlock', 'Rogue', 'Wizard'],
        components: ['S', 'V'],
        duration: 'Concentration, up to 1 minute',
        level: 2,
        material: null,
    ...
    'Dancing Lights': {
        classes: ['Rogue', 'Fighter', 'Sorcerer', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
        duration: 'Concentration, up to 1 minute',
        level: 0,
        material: null,
    ...
    Daylight: {
        classes: ['Druid', 'Paladin', 'Ranger', 'Cleric', 'Sorcerer'],
        components: ['S', 'V'],
        duration: '1 hour',
        level: 3,
        material: null,
    ...
    'Dimension Door': {
        classes: ['Paladin', 'Sorcerer', 'Cleric', 'Bard', 'Warlock', 'Wizard'],
        components: ['V'],
        duration: 'Instantaneous',
        level: 4,
        material: null,
    ...
    'Disguise Self': {
        classes: ['Rogue', 'Sorcerer', 'Cleric', 'Wizard', 'Bard'],
        components: ['S', 'V'],
        duration: '1 hour',
        level: 1,
        material: null,
    ...
    'Divine Word': {
        ...
        source_page: 234,
        text:
            "You utter a divine word, imbued with the power that shaped the world at the dawn of creation. Choose any number of creatures you can see within range. Each creature that can hear you must make a Charisma saving throw. On a failed save, a creature suffers an effect based on its current hit points. \u00e2\u20ac\u00a2 50 hit points or fewer - deafened for 1 minute \u00e2\u20ac\u00a2 40 hit points or fewer - deafened and blinded for 10 minutes \u00e2\u20ac\u00a2 30 hit points or fewer - blinded, deafened, and stunned for 1 hour \u00e2\u20ac\u00a2 20 hit points or fewer - killed instantly Regardless of its current hit points, a celestial, an elemental, a fey, or a fiend that fails its save is forced back to its plane of origin (if it isn't there already) and can't return to your current plane for 24 hours by any means short of a wish spell.",
        time: '1 bonus action'
    },
    'Dominate Beast': {
        classes: ['Druid', 'Sorcerer', 'Cleric', 'Warlock'],
        components: ['S', 'V'],
        duration: 'Concentration, up to 1 minute',
        level: 4,
        material: null,
    ...
    'Dominate Monster': {
        classes: ['Rogue', 'Sorcerer', 'Warlock', 'Wizard', 'Bard'],
        components: ['S', 'V'],
        duration: 'Concentration, up to 1 hour',
        level: 8,
        material: null,
    ...
    Dream: {
        classes: ['Druid', 'Warlock', 'Rogue', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
        duration: '8 hours',
        level: 5,
        material:
    ...
    Druidcraft: {
        ...
        source_page: 236,
        text:
            'Whispering to the spirits of nature, you create one of the following effects within range. \u00e2\u20ac\u00a2 You create a tiny, harmless sensory effect that predicts what the weather will be at your location for the next 24 hours. The effect might manifest as a golden orb for clear skies, a cloud for rain, falling snowflakes for snow, and so on. This effect persists for 1 round. \u00e2\u20ac\u00a2 You instantly make a flower blossom, a seed pod open, or a leaf bud bloom. \u00e2\u20ac\u00a2 You create an instantaneous, harmless sensory effect, such as falling leaves, a puff of wind, the sound of a small animal, or the faint odor of skunk. The effect must fit in a 5-foot cube. \u00e2\u20ac\u00a2 You instantly light or snuff out a candle, a torch, or a small campfire.',
        time: '1 action'
    },
    Earthquake: {
        classes: ['Druid', 'Sorcerer', 'Cleric'],
        components: ['S', 'V', 'M'],
        duration: 'Concentration, up to 1 minute',
        level: 8,
    ...
    'Faerie Fire': {
        classes: ['Druid', 'Warlock', 'Cleric', 'Bard'],
        components: ['V'],
        duration: 'Concentration, up to 1 minute',
        level: 1,
        material: null,
    ...
    'Feign Death': {
        classes: ['Druid', 'Warlock', 'Cleric', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
        duration: '1 hour',
        level: 3,
    ...
    'Fire Shield': {
        classes: ['Fighter', 'Warlock', 'Wizard'],
        components: ['S', 'V', 'M'],
        duration: '10 minutes',
        level: 4,
    ...
    'Fog Cloud': {
        classes: ['Druid', 'Ranger', 'Cleric', 'Wizard', 'Sorcerer'],
        components: ['S', 'V'],
        duration: 'Concentration, up to 1 hour',
        level: 1,
        material: null,
    ...
    Foresight: {
        classes: ['Druid', 'Warlock', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
        duration: '8 hours',
        level: 9,
    ...
    Geas: {
        classes: ['Druid', 'Paladin', 'Cleric', 'Bard', 'Rogue', 'Wizard'],
        components: ['V'],
        duration: '30 days',
        level: 5,
        material: null,
    ...
    'Glyph of Warding': {
        classes: ['Fighter', 'Cleric', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
    ...
    'Greater Invisibility': {
        classes: ['Druid', 'Sorcerer', 'Bard', 'Warlock', 'Rogue', 'Wizard'],
        components: ['S', 'V'],
        duration: 'Concentration, up to 1 minute',
        level: 4,
        material: null,
    ...
    'Greater Restoration': {
        ...
        source_page: 246,
        text:
            "You imbue a creature you touch with positive energy to undo a debilitating effect. You can reduce the target's exhaustion level by one, or end one of the following effects on the target. \u00e2\u20ac\u00a2 One effect that charmed or petrified the target \u00e2\u20ac\u00a2 One curse, including the target's attunement to a cursed magic item \u00e2\u20ac\u00a2 Any reduction to one of the target's ability scores \u00e2\u20ac\u00a2 One effect reducing the target's hit point maximum",
        time: '1 action'
    },
    'Guardian of Faith': {
        classes: ['Paladin', 'Cleric'],
    ...
    'Gust of Wind': {
        classes: ['Druid', 'Fighter', 'Sorcerer', 'Cleric', 'Wizard'],
        components: ['S', 'V', 'M'],
        duration: 'Concentration, up to 1 minute',
        level: 2,
    ...
    'Illusory Script': {
        classes: ['Rogue', 'Warlock', 'Wizard', 'Bard'],
        components: ['S', 'M'],
        duration: '10 days',
        level: 1,
        material:
    ...
    'Legend Lore': {
        classes: ['Warlock', 'Cleric', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
        duration: 'Instantaneous',
        level: 5,
        material:
    ...
    Light: {
        classes: ['Fighter', 'Sorcerer', 'Cleric', 'Wizard', 'Bard'],
        components: ['V', 'M'],
        duration: '1 hour',
        level: 0,
    ...
    'Lightning Bolt': {
        classes: ['Druid', 'Fighter', 'Sorcerer', 'Wizard'],
        components: ['S', 'V', 'M'],
        duration: 'Instantaneous',
        level: 3,
    ...
    'Locate Creature': {
        classes: ['Druid', 'Paladin', 'Cleric', 'Bard', 'Ranger', 'Wizard'],
        components: ['S', 'V', 'M'],
        duration: 'Concentration, up to 1 hour',
        level: 4,
        material: 'a bit of fur from a bloodhound',
    ...
    'Magic Circle': {
        classes: ['Paladin', 'Fighter', 'Warlock', 'Cleric', 'Wizard'],
        components: ['S', 'V', 'M'],
        duration: '1 hour',
        level: 3,
        material:
    ...
    'Magic Missile': {
        classes: ['Fighter', 'Sorcerer', 'Cleric', 'Wizard'],
        components: ['S', 'V'],
        duration: 'Instantaneous',
        level: 1,
        material: null,
    ...
    'Mirage Arcane': {
        classes: ['Druid', 'Rogue', 'Wizard', 'Bard'],
        components: ['S', 'V'],
        duration: '10 days',
        level: 7,
        material: null,
    ...
    'Mirror Image': {
        classes: ['Druid', 'Sorcerer', 'Cleric', 'Warlock', 'Rogue', 'Wizard'],
        components: ['S', 'V'],
        duration: '1 minute',
        level: 2,
        material: null,
    ...
    'Modify Memory': {
        classes: ['Rogue', 'Cleric', 'Wizard', 'Bard'],
        components: ['S', 'V'],
        duration: 'Concentration, up to 1 minute',
        level: 5,
        material: null,
    ...
    Nondetection: {
        classes: ['Fighter', 'Ranger', 'Cleric', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
        duration: '8 hours',
        level: 3,
        material:
    ...
    'Planar Binding': {
        classes: ['Druid', 'Cleric', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
        duration: '24 hours',
        level: 5,
    ...
    'Plane Shift': {
        classes: ['Druid', 'Sorcerer', 'Cleric', 'Warlock', 'Wizard'],
        components: ['S', 'V', 'M'],
        duration: 'Instantaneous',
        level: 7,
        material:
    ...
    'Plant Growth': {
        classes: ['Druid', 'Paladin', 'Ranger', 'Cleric', 'Warlock'],
        components: ['S', 'V'],
        duration: 'Instantaneous',
        level: 3,
        material: null,
    ...
    'Poison Spray': {
        ...
        source_page: 266,
        text:
            "You extend your hand toward a creature you can see within range and project a puff of noxious gas from your palm. The creature must succeed on a Constitution saving throw or take 1d12 poison damage. This spell's damage increases by 1d12 when you reach 5th level (2d12), 11th level (3d12), and 17 level (4d12).",
        time: '1 action'
    },
    Polymorph: {
        classes: ['Druid', 'Sorcerer', 'Cleric', 'Wizard', 'Bard'],
        ...
        source_page: 266,
        text:
            "This spell transforms a creature with at least 1 hit point that you can see within range into a new form. An unwilling creature must make a Wisdom saving throw to avoid the effect. A shapechanger automatically succeeds on this saving throw. The transformation lasts for the duration, or until the target drops to 0 hit points or dies. The new form can be any beast whose challenge rating is equal to or less than the target's (or the target's level, if it doesn't have a challenge rating). The target's game statistics, including mental ability scores, are replaced by the statistics of the chosen beast. It retains its alignment and personality. The target assumes the hit points of its new form. When it reverts to its normal form, the creature returns to the number of hit points it had before it transformed. If it reverts as a result of dropping to 0 hit points, any excess damage carries over to its normal form. As long as the excess damage doesn't reduce the creature's normal form to 0 hit points, it isn't knocked unconscious. The creature is limited in the actions it can perform by the nature of its new form, and it can't speak, cast spells, or take any other action that requires hands or speech. The target's gear melds into the new form. The creature can't activate, use, wield, or otherwise benefit from any of its equipment.",
        time: '1 action'
    },
    'Power Word Heal': {
        classes: ['Bard'],
    ...
    Prestidigitation: {
        ...
        source_page: 267,
        text:
            'This spell is a minor magical trick that novice spellcasters use for practice. You create one of the following magical effects within range. \u00e2\u20ac\u00a2 You create an instantaneous, harmless sensory effect, such as a shower of sparks, a puff of wind, faint musical notes, or an odd odor. \u00e2\u20ac\u00a2 You instantaneously light or snuff out a candle, a torch, or a small campfire. \u00e2\u20ac\u00a2 You instantaneously clean or soil an object no larger than 1 cubic foot. \u00e2\u20ac\u00a2 You chill, warm, or flavor up to 1 cubic foot of nonliving material for 1 hour. \u00e2\u20ac\u00a2 You make a color, a small mark, or a symbol appear on an object or a surface for 1 hour. \u00e2\u20ac\u00a2 You create a nonmagical trinket or an illusory image that can fit in your hand and that lasts until the end of your next turn. If you cast this spell multiple times, you can have up to three of its non-instantaneous effects active at a time, and you can dismiss such an effect as an action.',
        time: '1 action'
    },
    'Prismatic Spray': {
        classes: ['Sorcerer', 'Wizard'],
    ...
    Scrying: {
        classes: ['Druid', 'Paladin', 'Cleric', 'Bard', 'Warlock', 'Wizard'],
        components: ['S', 'V', 'M'],
        duration: 'Concentration, up to 10 minutes',
        level: 5,
        material:
    ...
    Sending: {
        classes: ['Fighter', 'Warlock', 'Cleric', 'Wizard'],
        components: ['S', 'V', 'M'],
        duration: '1 round',
        level: 3,
    ...
    Shatter: {
        classes: ['Sorcerer', 'Cleric', 'Bard', 'Fighter', 'Warlock', 'Wizard'],
        components: ['S', 'V', 'M'],
        duration: 'Instantaneous',
        level: 2,
    ...
    Silence: {
        classes: ['Druid', 'Ranger', 'Cleric', 'Warlock', 'Bard'],
        components: ['S', 'V'],
        duration: 'Concentration, up to 10 minutes',
        level: 2,
        material: null,
    ...
    'Silent Image': {
        classes: ['Rogue', 'Sorcerer', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
    ...
    'Stinking Cloud': {
        classes: ['Druid', 'Sorcerer', 'Warlock', 'Wizard', 'Bard'],
        components: ['S', 'V', 'M'],
        duration: 'Concentration, up to 1 minute',
        level: 3,
    ...
    Suggestion: {
        classes: ['Sorcerer', 'Cleric', 'Bard', 'Warlock', 'Rogue', 'Wizard'],
        components: ['V', 'M'],
        duration: 'Concentration, up to 8 hours',
        level: 2,
        material:
    ...
    "Tasha's Hideous Laughter": {
        ...
        duration: 'Concentration, up to 1 minute',
        level: 1,
        material: 'tiny tarts and a feather that waved in the air',
        range: '30 feet',
        ritual: false,
        school: 'Enchantment',
        source: "Player's Handbook",
    ...
    Thaumaturgy: {
        ...
        source_page: 282,
        text:
            'You manifest a minor wonder, a sign of supernatural power, within range. You create one of the following magical effects within range. \u00e2\u20ac\u00a2 Your voice booms up to three times as loud as normal for 1 minute. \u00e2\u20ac\u00a2 You cause flames to flicker, brighten, dim, or change color for 1 minute. \u00e2\u20ac\u00a2 You cause harmless tremors in the ground for 1 minute. \u00e2\u20ac\u00a2 You create an instantaneous sound that originates from a point of your choice within range, such as a rumble of thunder, the cry of a raven, or ominous whispers. \u00e2\u20ac\u00a2 You instantaneously cause an unlocked door or window to fly open or slam shut. \u00e2\u20ac\u00a2 You alter the appearance of your eyes for 1 minute. If you cast this spell multiple times, you can have up to three of its 1-minute effects active at a time, and you can dismiss such an effect as an action.',
        time: '1 action'
    },
    'Thorn Whip': {
        classes: ['Druid'],
    ...
    Thunderwave: {
        classes: ['Druid', 'Sorcerer', 'Cleric', 'Bard', 'Fighter', 'Wizard'],
        components: ['S', 'V'],
        duration: 'Instantaneous',
        level: 1,
        material: null,
    ...
    'Water Walk': {
        classes: ['Druid', 'Ranger', 'Cleric', 'Sorcerer'],
        components: ['S', 'V', 'M'],
        duration: '1 hour',
        level: 3,
    ...
    Wish: {
        ...
        source_page: 288,
        text:
            "Wish is the mightiest spell a mortal creature can cast. By simply speaking aloud, you can alter the very foundations of reality in accord with your desires. The basic use of this spell is to duplicate any other spell of 8th level or lower. You don't need to meet any requirements in that spell, including costly components. The spell simply takes effect. Alternatively, you can create one of the following effects of your choice. \u00e2\u20ac\u00a2 You create one object of up to 25,000 gp in value that isn't a magic item. The object can be no more than 300 feet in any dimension, and it appears in an unoccupied space you can see on the ground. \u00e2\u20ac\u00a2 You allow up to twenty creatures that you can see to regain all hit points, and you end all effects on them described in the greater restoration spell. \u00e2\u20ac\u00a2 You grant up to ten creatures that you can see resistance to a damage type you choose. \u00e2\u20ac\u00a2 You grant up to ten creatures you can see immunity to a single spell or other magical effect for 8 hours. For instance, you could make yourself and all your companions immune to a lich's life drain attack. \u00e2\u20ac\u00a2 You undo a single recent event by forcing a reroll of any roll made within the last round (including your last turn). Reality reshapes itself to accommodate the new result. For example, a wish spell could undo an opponent's successful save, a foe's critical hit, or a friend's failed save. You can force the reroll to be made with advantage or disadvantage, and you can choose whether to use the reroll or the original roll. You might be able to achieve something beyond the scope of the above examples. State your wish to the DM as precisely as possible. The DM has great latitude in ruling what occurs in such an instance, the greater the wish, the greater the likelihood that something goes wrong. This spell might simply fail, the effect you desire might only be partly achieved, or you might suffer some unforeseen consequence as a result of how you worded the wish. For example, wishing that a villain were dead might propel you forward in time to a period when that villain is no longer alive, effectively removing you from the game. Similarly, wishing for a legendary magic item or artifact might instantly transport you to the presence of the item's current owner. The stress of casting this spell to produce any effect other than duplicating another spell weakens you. After enduring that stress, each time you cast a spell until you finish a long rest, you take 1d10 necrotic damage per level of that spell. This damage can't be reduced or prevented in any way. In addition, your Strength drops to 3, if it isn't 3 or lower already, for 2d4 days. For each of those days that you spend resting and doing nothing more than light activity, your remaining recovery time decreases by 2 days. Finally, there is a 33 percent chance that you are unable to cast Wish ever again if you suffer this stress.",
        time: '1 action'
    },
    'Witch Bolt': {
        classes: ['Fighter', 'Sorcerer', 'Warlock', 'Wizard'],
